...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Account accounto2 = new Account();
        Account accounto3 = new Account();
        Account accounto4 = new Account();

        accounto1.setEmail("user@user.com");
        accounto1.setPassword("password");
        accounto1.setFirstName("user");
        accounto1.setLastName("lastname");
        accounto1.setAge(25);
        accounto1.setDate_of_birth(LocalDate.parse("1999-01-01"));
        accounto1.setGender("Male");

        accounto2.setEmail("ratshalingwaadivhaho106@gmail.com");
        accounto2.setPassword("password");
        accounto2.setFirstName("admin");
        accounto2.setLastName("lastname");
        accounto2.setRole(Roles.ADMIN.getRole());
        accounto2.setAge(20);
        accounto2.setDate_of_birth(LocalDate.parse("2004-01-01"));
        accounto2.setGender("Male");

        accounto3.setEmail("editor@editor.com");
        accounto3.setPassword("password");
        accounto3.setFirstName("editor");
        accounto3.setLastName("lastname");
        accounto3.setRole(Roles.EDITOR.getRole());
        accounto3.setAge(35);
        accounto3.setDate_of_birth(LocalDate.parse("1989-01-01"));
        accounto3.setGender("Male");

        accounto4.setEmail("super_editor@editor.com");
        accounto4.setPassword("password");
        accounto4.setFirstName("super_editor");
        accounto4.setLastName("lastname");
        accounto4.setAge(25);
        accounto4.setDate_of_birth(LocalDate.parse("1999-01-01"));
        accounto4.setGender("Female");
        accounto4.setRole(Roles.EDITOR.getRole());
        Set<Authority> authorities = new HashSet<>();
        authorityService.findById(Privillages.RESET_ANY_USER_PASSWORD.getId()).ifPresent(authorities::add);
        authorityService.findById(Privillages.ACCESS_ADMIN_PANEL.getId()).ifPresent(authorities::add);
        accounto4.setAuthorities(authorities);

        accountService.save(accounto1);
        accountService.save(accounto2);
        accountService.save(accounto3);
        accountService.save(accounto4);
