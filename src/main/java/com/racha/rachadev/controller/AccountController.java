...
import com.racha.rachadev.util.AppUtil;
...
public class AccountController {
        ...
        if (file.isEmpty()) {
            ...
            try {
                ...
                if (optionalAccount.isPresent()) {
                    ...
                    // String relativeFileLocation = Photo_prifix.replace("**", "uploads/" + final_photo_name);
                    ...
                    Account account = optionalAccount.get();
                    account.setPhoto(Photo_prifix.replace("**", "uploads/" + final_photo_name));
                    accountService.save(account);
    ...
    public String changePasswordString(Model model, @RequestParam("token") String token,RedirectAttributes attributes) {
